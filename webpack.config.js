...
var env = {
	...
	QC_RESOURCE_API: JSON.stringify('http://firebrand.solutions/qcapi/api/res/'),
	QC_API: JSON.stringify('http://firebrand.solutions/qcapi/api/v1/'),
    QC_IMAGES_PATH: JSON.stringify('image/'), // Relative path to catalog image folder
    QC_IMAGES_URI: JSON.stringify('http://firebrand.solutions/image/')*/
