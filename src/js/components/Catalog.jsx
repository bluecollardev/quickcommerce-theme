        ...
        return (
            <main className='content-wrapper'>{/* Main Content Wrapper */}
                ...
                <section className='entryModule entryModule--saloni triggrParallx'>
                  <div className='hidden-xs entryModule__tile entryModule__tile--latter slideUp' style={{transform: 'matrix(1, 0, 0, 1, 0, -30)'}}>
                    <div className='tileBg animateInView animateInView--pix isInView' data-delay='narrow' />
                  </div>
                  {/* entryModule__tile--latter */}
                  <div className='hidden-xs entryModule__tile entryModule__tile--former slideDown--slow' style={{transform: 'matrix(1, 0, 0, 1, 0, 100)'}}>
