            ...
            <section className="hero-slider" data-loop="true" data-autoplay="true" data-interval={7000}>
                ...
                */}
                ...
                <div className='superfood-block js-parallax'>
                    ...
                    <img className='grass floating-grass floating-element js-parallax' data-ratio='0.1' src='./img/template/phobulous/grass.png' alt style={{transform: 'translateY(109.9px) translateZ(0px)'}} />
                    <img className='grass-2 floating-grass-2 floating-element js-parallax' data-ratio='-0.1' src='./img/template/phobulous/grass-2.png' alt style={{transform: 'translateY(-109.9px) translateZ(0px)'}} />
                    <div className='widget widget-static-block'>
                        ...
                        <div className='superfood-img'>
                            ...
                            <img className='floating-element js-parallax leaf' data-ratio='-0.5' src='./img/template/phobulous/leaf.png' alt style={{transform: 'translateY(-54.95px) translateZ(0px)'}} />
                            ...
                            <img className='floating-element js-parallax leaf-3' data-ratio='0.1' src='./img/template/phobulous/leaf-3.png' alt style={{transform: 'translateY(27.475px) translateZ(0px)'}} />
                            <img className='floating-element js-parallax leaf-4' data-ratio='-0.2' src='./img/template/phobulous/leaf-4.png' alt style={{transform: 'translateY(-54.95px) translateZ(0px)'}} />
                            ...
                            <img className='floating-element js-parallax leaf-13' data-ratio='-0.4' src='./img/template/phobulous/leaf-13.png' alt style={{transform: 'translateY(-109.9px) translateZ(0px)'}} />
                        </div>
                    </div>
                </div>
            </section>
