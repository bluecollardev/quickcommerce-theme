...
import ProductSummary from 'quickcommerce-react/components/summary/ProductSummary.jsx'
import ProductOptionRow from 'quickcommerce-react/components/catalog/ProductOptionRow.jsx'

import QcProduct from 'quickcommerce-react/components/shop/Product.jsx'
...
class Product extends QcProduct {
    constructor(props) {
    ...
    loadProduct() {
        ...
        if (typeof this.props.match !== 'undefined' && 
            ...
            typeof this.props.match.params.itemId !== 'undefined' && !isNaN(this.props.match.params.itemId)) {
            ...
            if (fetch) {
                ...
                this.props.productService.fetch(itemId, () => {
                    this.setState({
                        product: this.props.productStore.getProduct()
                    })
    ...
    render() {
        ...
        let slideStyle = {
            backgroundImage: 'url(' + primaryImage + ')', // Temp!
        }
...
export default CartContext(Product)