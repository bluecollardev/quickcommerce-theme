...
export default class ShopFullwidthFt extends Component {
  render() {
    return (
      <div>
        {/* Page Preloading */}
        ...
        <div className="page-wrapper">
                  ...
                  <ul className="main-navigation space-bottom">
                    ...
                    <li className="menu-item-has-children current-menu-item">
                      ...
                      <ul className="sub-menu">
                        ...
                        <li className="current-menu-item"><a href="shop-fullwidth-ft.html">Full Width Filters Top</a></li>
          ...
          <section className="container-fluid padding-top-3x">
            <h1 className="space-top-half tablet-center">Shop Full Width Filters Top</h1>
