...
export default class OculusRift extends Component {
  render() {
    return (
      ...
      <article className="order-details">
        <div className="order-totals">
          <div className="product-image">
            <img src="ajax/img/order01.jpg" alt="Oculus Rift" />
          </div>
          <div className="order-totals-detail">
            <h2 className="product-title">Oculus Rift</h2>
            <input type="hidden" name="product_name" defaultValue="Oculus Rift" />
            <div className="order-quantity">
              ...
              <span>×</span>
              <span className="price">$<i>599.00</i></span>
            </div>
            <h4 className="total-cost"><span className="text-thin">Total costs:</span> $<i>599.00</i></h4>
            <input type="hidden" name="total_cost" defaultValue="$599.00" />
          </div>
        </div>
        <hr />
