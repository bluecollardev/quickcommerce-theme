...
export default class XboxController extends Component {
  render() {
    return (
      ...
      <article className="order-details">
        <div className="order-totals">
          <div className="product-image">
            <img src="ajax/img/order04.jpg" alt="Xbox Controller" />
          </div>
          <div className="order-totals-detail">
            <h2 className="product-title">Xbox Controller</h2>
            <input type="hidden" name="product_name" defaultValue="Xbox Controller" />
            <div className="order-quantity">
              ...
              <span>×</span>
              <span className="price">$<i>50.00</i></span>
            </div>
            <h4 className="total-cost"><span className="text-thin">Total costs:</span> $<i>50.00</i></h4>
            <input type="hidden" name="total_cost" defaultValue="$50.00" />
          </div>
        </div>
        <hr />
