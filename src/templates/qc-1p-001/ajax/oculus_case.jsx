...
export default class OculusCase extends Component {
  render() {
    return (
      ...
      <article className="order-details">
        <div className="order-totals">
          <div className="product-image">
            <img src="ajax/img/order06.jpg" alt="Oculus Case" />
          </div>
          <div className="order-totals-detail">
            <h2 className="product-title">Oculus Case</h2>
            <input type="hidden" name="product_name" defaultValue="Oculus Case" />
            <div className="order-quantity">
              ...
              <span>×</span>
              <span className="price">$<i>44.00</i></span>
            </div>
            <h4 className="total-cost"><span className="text-thin">Total costs:</span> $<i>44.00</i></h4>
            <input type="hidden" name="total_cost" defaultValue="$44.00" />
          </div>
        </div>
        <hr />
