...
export default class OculusEarphones extends Component {
  render() {
    return (
      ...
      <article className="order-details">
        <div className="order-totals">
          <div className="product-image">
            <img src="ajax/img/order05.jpg" alt="Oculus Earphones" />
          </div>
          <div className="order-totals-detail">
            <h2 className="product-title">Oculus Earphones</h2>
            <input type="hidden" name="product_name" defaultValue="Oculus Earphones" />
            <div className="order-quantity">
              ...
              <span>×</span>
              <span className="price">$<i>49.00</i></span>
            </div>
            <h4 className="total-cost"><span className="text-thin">Total costs:</span> $<i>49.00</i></h4>
            <input type="hidden" name="total_cost" defaultValue="$49.00" />
          </div>
        </div>
        <hr />
