      ...
      <article className="order-details">
        <div className="order-totals">
          <div className="product-image">
            <img src="ajax/img/order03.jpg" alt="Oculus Sensor" />
          </div>
          <div className="order-totals-detail">
            <h2 className="product-title">Oculus Sensor</h2>
            <input type="hidden" name="product_name" defaultValue="Oculus Sensor" />
            <div className="order-quantity">
              ...
              <span>×</span>
              <span className="price">$<i>79.00</i></span>
            </div>
            <h4 className="total-cost"><span className="text-thin">Total costs:</span> $<i>79.00</i></h4>
            <input type="hidden" name="total_cost" defaultValue="$79.00" />
          </div>
        </div>
        <hr />
