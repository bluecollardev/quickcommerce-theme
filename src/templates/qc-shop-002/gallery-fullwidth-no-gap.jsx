...
export default class GalleryFillwidthNoGap extends Component {
  render() {
    return (
      <div>
        {/* Page Preloading */}
              ...
              <ul className="menu">
                ...
                <li className="menu-item-has-children current-menu-item">
                  ...
                  <ul className="sub-menu">
                    ...
                    <li className="current-menu-item"><a href="gallery-fullwidth-no-gap.html">Full Width No Gap</a></li>
