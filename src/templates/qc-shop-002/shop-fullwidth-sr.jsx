...
export default class ShopFullwidthSr extends Component {
  render() {
    return (
      <div>
        <meta charSet="utf-8" />
        <title>M-Store | Shop Full Width Sidebar Right</title>
        {/*SEO Meta Tags*/}
        ...
        <div className="page-wrapper">
              ...
              <ul className="menu">
                ...
                <li className="menu-item-has-children current-menu-item">
                  ...
                  <ul className="sub-menu">
                    ...
                    <li className="current-menu-item"><a href="shop-fullwidth-sr.html">Full Width Sidebar Right</a></li>
          ...
          <section className="container-fluid padding-top-3x padding-bottom-3x">
            ...
            <div className="sidebar-toggle sidebar-toggle-right">
              <i className="material-icons filter_list" />
            </div>
            <h1 className="space-top-half">Shop Full Width Sidebar Right</h1>
