...
export default class ShopSidebarRight extends Component {
  render() {
    return (
      <div>
        <meta charSet="utf-8" />
        <title>M-Store | Shop Boxed Sidebar Right</title>
        {/*SEO Meta Tags*/}
        ...
        <div className="page-wrapper">
                ...
                <ul className="menu">
                  ...
                  <li className="menu-item-has-children current-menu-item">
                    ...
                    <ul className="sub-menu">
                      ...
                      <li className="current-menu-item"><a href="shop-sidebar-right.html">Shop Sidebar Right</a></li>
          ...
          <main className="content-wrapper">
            ...
            <section className="container padding-top-3x padding-bottom-3x">
              ...
              <h1 className="space-top-half">Shop Boxed Sidebar Right</h1>
