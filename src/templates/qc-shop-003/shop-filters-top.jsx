...
export default class ShopFiltersTop extends Component {
  render() {
    return (
      <div>
        <meta charSet="utf-8" />
        <title>M-Store | Shop Boxed Filters Top</title>
        {/*SEO Meta Tags*/}
                ...
                <ul className="menu">
                  ...
                  <li className="menu-item-has-children current-menu-item">
                    ...
                    <ul className="sub-menu">
                      ...
                      <li className="current-menu-item"><a href="shop-filters-top.html">Shop Filters Top</a></li>
