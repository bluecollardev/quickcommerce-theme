...
export default class ShopSidebarLeft extends Component {
  render() {
    return (
      <div>
        <meta charSet="utf-8" />
        <title>M-Store | Shop Boxed Sidebar Left</title>
        {/*SEO Meta Tags*/}
              ...
              <nav className="main-navigation">
                <ul className="menu">
                  ...
                  <li className="menu-item-has-children current-menu-item">
                    <a href="#">Shop</a>
                    <ul className="sub-menu">
                      <li className="current-menu-item"><a href="shop-sidebar-left.html">Shop Sidebar Left</a></li>
